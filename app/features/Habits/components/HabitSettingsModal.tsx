...
export const HabitSettingsModal = ({
    ...
    const handleRemoveNotificationTime = (time: string) => {
      const times = editedHabit.notificationTimes || [];
      handleChange("notificationTimes", times.filter(t => t !== time));
    };
  
    const handleToggleDay = (day: string) => {
      const days = editedHabit.notificationDays || [];
      if (days.includes(day)) {
        handleChange("notificationDays", days.filter(d => d !== day));
      } else {
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() => {
                          const nextFreq = {
                            ...
                            weekly: "custom",
                            custom: "daily",
                          }[editedHabit.notificationFrequency || "daily"] as "daily" | "weekly" | "custom";
                      ...
                      <View style={styles.daysPicker}>
                        {DAYS_OF_WEEK.map(day => (
                          <TouchableOpacity
                            ...
                            style={[
                              styles.dayOption,
                              (editedHabit.notificationDays || []).includes(day) && styles.selectedDayOption
                            ]}
