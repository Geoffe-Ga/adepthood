# adepthood-typescript-linters

Adepthood Typescript Linters - A quality-controlled TypeScript project generated with
...
cd adepthood-typescript-linters
...
Expected output:
```
Hello from adepthood-typescript-linters!
```
