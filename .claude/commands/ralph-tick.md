...
```bash
STATUS=$(scripts/ralph/pr-ready.sh "$PR_NUM") && RC=0 || RC=$?   # ready | ready-unreviewed | behind | unknown | draft | blocked | conflicted | pending | ci-failed | changes-requested | awaiting-review | optout
```
