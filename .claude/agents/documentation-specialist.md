...
- Honor the product voice from `NORTH-STAR.md` in user-facing copy.

## Example

**Issue**: new `complete_habit()` domain function. Add a Google-style docstring
(args, returns, the `HabitNotFound` raise), a one-line usage note in the habits
