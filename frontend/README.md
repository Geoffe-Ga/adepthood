...
| `EXPO_PUBLIC_SANGHA_INVITE_URL`        | No                | _(unset)_                                          | Permanent, never-expiring Discord invite for the Digital Sangha. Must be `https`. Unset means Settings offers no Sangha door at all. |
